/* $USAGI: addrconf.h,v 1.26 2002/02/25 15:04:06 takamiya Exp $ */
...
extern int ipv6_tunnel_addr_add(struct net_device *dev, struct in6_addr *addr);
extern int ipv6_tunnel_addr_del(struct net_device *dev, struct in6_addr *addr);
#endif
#endif
