...
/*
 * Bits in the R5900 coprosessor 0 config register.
 *
 ...
 */
#define R5900_CONF_BPE			(1 << 12)
#define R5900_CONF_NBE			(1 << 13)
#define R5900_CONF_DCE			(1 << 16)
#define R5900_CONF_ICE			(1 << 17)  /* conflict with CONF_SC */
#define R5900_CONF_DIE			(1 << 18)
