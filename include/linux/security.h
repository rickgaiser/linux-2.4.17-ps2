...
extern int cap_ip_decode_options (struct sk_buff *skb, const char *optptr,unsigned char **pp_ptr); 
...
static inline void security_capset_set (struct task_struct *target, kernel_cap_t *effective,
					kernel_cap_t *inheritable, kernel_cap_t *permitted)
{
...
static inline int security_sb_mount (char *dev_name, struct nameidata *nd, char *type,
				     unsigned long flags, void *data)
{
	return security_ops->sb_mount (dev_name, nd, type, flags, data);
}

static inline int security_sb_check_sb (struct vfsmount *mnt, struct nameidata *nd)
{
...
static inline void security_sb_post_remount (struct vfsmount *mnt, unsigned long flags,
					     void *data)
{
...
static inline int security_inode_create (struct inode *dir, struct dentry *dentry,
					 int mode)
{
	return security_ops->inode_create (dir, dentry, mode);
}

static inline void security_inode_post_create (struct inode *dir, struct dentry *dentry,
					       int mode)
{
...
static inline int security_inode_revalidate (struct dentry *inode)
{
	return security_ops->inode_revalidate (inode);
}
...
static inline int security_file_lock (struct file *file, unsigned int cmd,
				      int blocking)
{
	return security_ops->file_lock (file, cmd, blocking);
}
...
static inline int security_ip_decode_options (struct sk_buff *skb, const char *optptr,
...
static inline void security_socket_post_create (struct socket *sock, int family, int type,
						int protocol)
{
	security_ops->socket_post_create(sock, family, type, protocol);
}

static inline int security_socket_bind (struct socket *sock, struct sockaddr *address,
					int addrlen)
{
        return security_ops->socket_bind (sock, address, addrlen);
}

static inline int security_socket_connect (struct socket *sock, struct sockaddr *address,
					   int addrlen)
{
...
static inline int security_socket_sendmsg (struct socket *sock, struct msghdr *msg,
					   int size)
{
	return security_ops->socket_sendmsg (sock, msg, size);
}

static inline int security_socket_recvmsg (struct socket *sock, struct msghdr *msg,
                               int size, int flags)
{
...
static inline int security_socket_sock_rcv_skb (struct sock *sk, struct sk_buff *skb)
{
...
static inline int security_unix_stream_connect (struct socket *sock,
						       struct socket *other)
{
        return security_ops->unix_stream_connect (sock, other);
}
...
static inline int security_module_create (const char *name_user, size_t size)
{
        return security_ops->module_create (name_user, size);
}

static inline int security_module_initialize (struct module *mod_user)
{
        return security_ops->module_initialize (mod_user);
}
...
static inline int security_ipc_getinfo (int id, int cmd)
{
        return security_ops->ipc_getinfo (id, cmd);
}
...
static inline int security_msg_queue_associate (struct msg_queue *msq, int msgid,
                              		        int msgflg)
{
        return security_ops->msg_queue_associate (msq, msgid, msgflg);
}

static inline int security_msg_queue_msgctl (struct msg_queue *msq, int msgid, int cmd)
{
        return security_ops->msg_queue_msgctl (msq, msgid, cmd);
}

static inline int security_msg_queue_msgsnd (struct msg_queue *msq, struct msg_msg *msg,
                                              int msgid, int msgflg)
{
        return security_ops->msg_queue_msgsnd (msq, msg, msgid, msgflg);
}

static inline int security_msg_queue_msgrcv (struct msg_queue *msq, struct msg_msg *msg,
...
static inline int security_shm_associate (struct shmid_kernel *shp, int shmid, int shmflg)
{
        return security_ops->shm_associate (shp, shmid, shmflg);
}

static inline int security_shm_shmctl (struct shmid_kernel *shp, int shmid, int cmd)
{
        return security_ops->shm_shmctl(shp, shmid, cmd);
}

static inline int security_shm_shmat (struct shmid_kernel *shp, int shmid, char *shmaddr,
                          	      int shmflg)
{
        return security_ops->shm_shmat (shp, shmid, shmaddr, shmflg);
}
...
static inline int security_sem_associate (struct sem_array *sma, int semid, int semflg)
{
        return security_ops->sem_associate (sma, semid, semflg);
}

static inline int security_sem_semctl (struct sem_array *sma, int semid, int cmd)
{
        return security_ops->sem_semctl (sma, semid, cmd);
}

static inline int security_sem_semop (struct sem_array *sma, int semid, struct sembuf *sops,
                           	      unsigned nsops, int alter)
{
        return security_ops->sem_semop (sma, semid, sops, nsops, alter);
}

static inline int security_skb_alloc (struct sk_buff *skb)
{
        return security_ops->skb_alloc_security (skb);
}

static inline int security_skb_clone (struct sk_buff *newskb, const struct sk_buff *oldskb)
{
        return security_ops->skb_clone (newskb, oldskb);
}

static inline void security_skb_copy (struct sk_buff *newskb, const struct sk_buff *oldskb)
{
        security_ops->skb_copy (newskb, oldskb);
}

static inline void security_skb_set_owner_w (struct sk_buff *skb, struct sock *sk)
{
        security_ops->skb_set_owner_w (skb, sk);
}

static inline void security_skb_recv_datagram (struct sk_buff *skb, struct sock *sk,
                                  	       unsigned flags)
{
