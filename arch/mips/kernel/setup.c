...
extern void au1000_sysinit(void);
...
static inline void check_wait(void)
{
	...
	case CPU_R3081E:
		...
		printk(" available.\n");
		break;
#if 0 /* disabled temp until fix r39xx_wait fn */
	case CPU_TX3927:
#endif
	case CPU_TX39XX:
		cpu_wait = r39xx_wait;
...
void __init setup_arch(char **cmdline_p)
{
	...
	case MACH_GROUP_GALILEO:
		...
		break;
#endif
#if defined(CONFIG_MIPS_IVR) || defined(CONFIG_MIPS_ITE8172) || defined(CONFIG_MIPS_SNSC_MPU210)
	case  MACH_GROUP_ITE:
	case  MACH_GROUP_GLOBESPAN:
	case  MACH_GROUP_SNSC:
		it8172_setup();
		break;
#endif  
#ifdef CONFIG_NINO
