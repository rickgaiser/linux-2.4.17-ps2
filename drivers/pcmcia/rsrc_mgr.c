...
static struct resource pccard_io_resource = { "PC Card I/O", 0x0000, 0xffff, IORESOURCE_IO, NULL, NULL, NULL };
#endif
				    ...
				    struct pci_dev *dev)
{
	...
	/* For 16-bit PC Card support */
	if ((b & ~0xffffUL) == 0)
		return check_resource(&pccard_io_resource, b, n);
#endif
